import 'lambda-api';
import { ClarificationDocument } from 'app/clarification/types';
import { ClassDocument } from 'app/class/types';
import { CompanyDocument } from 'app/company/types';
import { ContestDocument } from 'app/contest/types';
import { CourseDocument } from 'app/course/types';
import { JudgeDocument } from 'app/judge/types';
import { ProblemDocument } from 'app/problem/types';
import { SessionDocument } from 'app/session/types';
import { SubmitDocument } from 'app/submission/types';
import { UserDocument } from 'app/user/types';
import { WorksheetDocument } from 'app/worksheet/types';
import { ResponseContentsType, ResponseContentType, ResponseErrorType } from 'types/response';
// import { ResponseContent, ResponseContents, ResponseError } from 'types';

declare module 'lambda-api' {
  import { S3ClientConfig } from '@aws-sdk/client-s3';
  import { APIGatewayEventRequestContext, APIGatewayProxyEvent, APIGatewayProxyEventV2, Context } from 'aws-lambda';
  ...
  export declare class Request<T extends {
    ...
    requestedCompany: CompanyDocument;
