...
/** Grupo oficial de Telegram: los dos canales del Concierge son el grupo y la
 *  casilla de soporte (`NEXT_PUBLIC_SUPPORT_EMAIL`). */
 ...
 *  equipo. Chat = grupo de Telegram; Email = casilla de soporte. */
