 ...
 * no es un fallo: se pinta en tono de espera y linkea el hash al explorador, que
 * es lo único que el usuario puede mirar mientras tanto. Quien renderice este
 * aviso debe además esconder su botón de reintento en ese estado; reintentar
 * mandaría la misma plata dos veces.
 */
