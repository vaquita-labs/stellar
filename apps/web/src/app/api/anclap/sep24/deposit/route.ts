...
// SEP-24 — POST /api/anclap/sep24/deposit { asset_code, account, amount } + Bearer JWT
// -> POST /transfer24/transactions/deposit/interactive
export async function POST(req: Request) {
  ...
  return reply(await postInteractive('deposit', jwt, payload));
}
