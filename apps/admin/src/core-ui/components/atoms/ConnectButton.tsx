...
export function ConnectButton({ onPress }: ConnectButtonProps) {
  return (
    <Button
      ...
      className="px-5 py-2 rounded-md w-full bg-primary border border-black border-b-3 text-black text-sm font-semibold hover:bg-primary/80 transition shadow-sm"
    >
      Connect Wallet
    </Button>
  );
