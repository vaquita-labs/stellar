export const VaquitaPoolAbi = [
  ...
  {
    "type": "function",
    "name": "accessManagedMSV",
    "inputs": [],
    "outputs": [
      { "name": "", "type": "address", "internalType": "contract IAccessManagedMSV" }
    ],
    "stateMutability": "view"
  },
  {
    ...
    "name": "addLockPeriod",
    "inputs": [
      { "name": "newLockPeriod", "type": "uint256", "internalType": "uint256" }
    ],
    "outputs": [],
    "stateMutability": "nonpayable"
  },
  ...
  },
  {
    ...
    "inputs": [
      ...
      { "name": "_accessManagedMSV", "type": "address", "internalType": "address" },
      { "name": "_lockPeriods", "type": "uint256[]", "internalType": "uint256[]" }
    ],
    "outputs": [],
    "stateMutability": "nonpayable"
  },
  ...
  },
  {
    ...
    "outputs": [
      { "name": "amountToTransfer", "type": "uint256", "internalType": "uint256" }
    ],
    "stateMutability": "nonpayable"
  },
  {
  ...
  },
  {
    ...
    "inputs": [
      { "name": "depositId", "type": "bytes32", "indexed": true, "internalType": "bytes32" },
      { "name": "owner", "type": "address", "indexed": true, "internalType": "address" },
      { "name": "transferAmount", "type": "uint256", "indexed": false, "internalType": "uint256" },
  ...
  },
  {
    ...
    "inputs": [
      { "name": "newLockPeriod", "type": "uint256", "indexed": false, "internalType": "uint256" }
    ],
    "anonymous": false
  },
  {
